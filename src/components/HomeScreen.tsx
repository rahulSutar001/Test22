  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-12 grid-pattern">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-10 w-full max-w-md sm:max-w-xl">
        ...
        <FeatureCard icon={<Zap className="w-5 h-5 text-accent" />} title="123" description="Instant speed readout" />
        <FeatureCard icon={<Shield className="w-5 h-5 text-primary" />} title="Aastha shete" description="Deep learning models" />
      </div>
